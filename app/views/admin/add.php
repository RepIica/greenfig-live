...
<div id="container">
	...
	<form action="<?php echo BASE_URL; ?>/admin/add.php" method="POST" autocomplete="off">
		...
		<label for="price2">
			Price 2:
		<input type="text" name="price2" id="price2" class="pricex" placeholder="only for 'The Bar' or 'The Herbal Garden' labels">
		</label>
		<label for="price3">
			Price 3:
			<input type="text" name="price3" id="price3" class="pricex" placeholder="only for 'The Bar' or 'The Herbal Garden' labels">
		</label>			
		<label for="price4">
			Price 4:
			<input type="text" name="price4" id="price4" class="pricex" placeholder="only for 'The Bar' or 'The Herbal Garden' labels">
		...
		<input type="submit" value="Add Page" onclick="makeDefault()">
	</form>
</div>
...
<script>
	...
	function makeDefault(){
		...
		if(input.value.length == 0){
			...
			console.log(x);		
			for (var i = 0; i < x; i++) {
				input.getElementsByClassName('.pricex')[i].value = 1.00;
			}
		}
